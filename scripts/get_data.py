...
os.environ["MLFLOW_REGISTRY_URI"] = "/home/serj/project/mlflow/"
mlflow.set_tracking_uri("http://localhost:5000")
mlflow.set_experiment("get_data")
 
key = "AIzaSyDuaR5gQex-2wPqio_rdahgNweYzG16DVE"
api = Api(api_key=key)
query = "'print DTF'"
...
with mlflow.start_run():
    ...
    mlflow.log_artifact(local_path="/home/serj/project/scripts/get_data.py",
                        artifact_path="get_data code")
    mlflow.end_run()
 
with open('/home/serj/project/datasets/data.csv', 'a') as f:
    f.write("{}\n".format(s))